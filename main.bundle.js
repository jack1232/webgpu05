...
/* harmony export */   "ShadersOld1": () => (/* binding */ ShadersOld1),
/* harmony export */   "ShadersOld": () => (/* binding */ ShadersOld)
/* harmony export */ });
const Shaders = () => {
    const vertex = `
        @vertex
...
const CreatePrimitive = (primitiveType = 'point-list') => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    const shader = (0,_shaders__WEBPACK_IMPORTED_MODULE_2__.Shaders)();
...
CreatePrimitive();
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#id-primitive').on('change', () => {
    const primitiveType = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#id-primitive').val();
